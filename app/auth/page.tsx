  ...
  return (
    <Modal>
      <ModalTrigger asChild>
        <Button variant="link" className="px-0 underline underline-offset-4 hover:text-primary">
          Terms of Service
        </Button>
      </ModalTrigger>
      <ModalContent>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <div className="relative">
                                    <Input {...field} type="text" placeholder="John Doe" className="pl-10" />
